...
export const Button = ({
  ...
  const baseButtonClasses =
    "min-w-fit font-semibold flex flex-row justify-center items-center overflow-hidden transition-all duration-200";
  ...
  const presetClasses = {
    ...
    blur: "bg-[#8F8F8F] bg-opacity-50 backdrop-blur-md text-white active:backdrop-blur-none active:bg-opacity-100",
    ...
    special:
      "bg-primary-gradient text-black border-lime-200 border active:bg-primary-200 active:text-white",
  };
  ...
  const textClasses = {
    ...
    md: "text-lg leading-7 font-medium",
    lg: "text-xl leading-7 font-medium",
  };
